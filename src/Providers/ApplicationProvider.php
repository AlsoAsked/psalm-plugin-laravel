...
final class ApplicationProvider
{
    ...
    public static function getApp(): LaravelApplication
    {
        ...
        if ($cwd !== false) { // Applications and Local Dev
            $applicationPath = $cwd . '/bootstrap/app.php';
        ...
        if ($app === null) {
            if (file_exists($applicationPath = dirname(__DIR__, 5) . '/bootstrap/app.php')) { // plugin installed to vendor
                /** @psalm-suppress MixedAssignment */
                $app = require $applicationPath;
